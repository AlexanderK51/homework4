...
; You must define these values
  ...
  !define PATCH  "2"
  !define INST_DIR "C:/Users/alexa/homework4/build/_CPack_Packages/win32/NSIS/SFML-2.6.2-MSVC-19.41.34120.0-Release"
...
;Include Modern UI
  ...
  InstallDir "$PROGRAMFILES\SFML 2.6.2"

;--------------------------------
;General

  ;Name and file
  Name "SFML 2.6.2 (MSVC 19.41.34120.0)"
  OutFile "C:/Users/alexa/homework4/build/_CPack_Packages/win32/NSIS/SFML-2.6.2-MSVC-19.41.34120.0-Release.exe"
...
!macro InitSection SecName
  ...
  ReadRegDWORD $AR_RegFlags HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\SFML 2.6.2\Components\${SecName}" "Installed"
...
!macro FinishSection SecName
  ...
  IntCmp $AR_SecFlags 1 "leave_${SecName}"
    ...
    WriteRegDWORD HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\SFML 2.6.2\Components\${SecName}" \
  "Installed" 0
    Goto "exit_${SecName}"
...
Function ConditionalAddToRegistry
  ...
  StrCmp "$0" "" ConditionalAddToRegistry_EmptyString
    WriteRegStr SHCTX "Software\Microsoft\Windows\CurrentVersion\Uninstall\SFML 2.6.2" \
    "$1" "$0"
...
!define MUI_WELCOMEFINISHPAGE_BITMAP "C:\Users\alexa\homework4\build\_deps\sfml-src\tools\nsis\sidebar.bmp"
!define MUI_HEADERIMAGE_BITMAP "C:\Users\alexa\homework4\build\_deps\sfml-src\tools\nsis\header.bmp"
!define MUI_ICON "C:\Users\alexa\homework4\build\_deps\sfml-src\tools\nsis\sfml.ico"
...
;Pages
  ...
  !insertmacro MUI_PAGE_LICENSE "C:/Users/alexa/homework4/build/_deps/sfml-src/license.md"
  ...
  !define MUI_STARTMENUPAGE_REGISTRY_KEY "Software\SFML Team\SFML 2.6.2"
...
Section "-Core installation"
  ...
  WriteRegStr SHCTX "Software\SFML Team\SFML 2.6.2" "" $INSTDIR

  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall.exe"
  Push "DisplayName"
  Push "SFML 2.6.2 (MSVC 19.41.34120.0)"
...
Function InstallOptionsPage
  !insertmacro MUI_HEADER_TEXT "Install Options" "Choose options for installing SFML 2.6.2 (MSVC 19.41.34120.0)"
...
Section "Uninstall"
  ReadRegStr $START_MENU SHCTX \
   "Software\Microsoft\Windows\CurrentVersion\Uninstall\SFML 2.6.2" "StartMenu"
  ;MessageBox MB_OK "Start menu is in: $START_MENU"
  ReadRegStr $DO_NOT_ADD_TO_PATH SHCTX \
    "Software\Microsoft\Windows\CurrentVersion\Uninstall\SFML 2.6.2" "DoNotAddToPath"
  ReadRegStr $ADD_TO_PATH_ALL_USERS SHCTX \
    "Software\Microsoft\Windows\CurrentVersion\Uninstall\SFML 2.6.2" "AddToPathAllUsers"
  ReadRegStr $ADD_TO_PATH_CURRENT_USER SHCTX \
    "Software\Microsoft\Windows\CurrentVersion\Uninstall\SFML 2.6.2" "AddToPathCurrentUser"
  ;MessageBox MB_OK "Add to path: $DO_NOT_ADD_TO_PATH all users: $ADD_TO_PATH_ALL_USERS"
  ReadRegStr $INSTALL_DESKTOP SHCTX \
    "Software\Microsoft\Windows\CurrentVersion\Uninstall\SFML 2.6.2" "InstallToDesktop"
  ...
  Delete "$INSTDIR\lib\cmake\SFML\SFMLStaticTargets-debug.cmake"
  Delete "$INSTDIR\lib\cmake\SFML\SFMLStaticTargets.cmake"
  Delete "$INSTDIR\lib\Debug"
  Delete "$INSTDIR\lib\Debug\sfml-graphics-s-d.pdb"
  Delete "$INSTDIR\lib\Debug\sfml-graphics-s.pdb"
  Delete "$INSTDIR\lib\Debug\sfml-main-d.pdb"
  Delete "$INSTDIR\lib\Debug\sfml-main-s.pdb"
  Delete "$INSTDIR\lib\Debug\sfml-system-s-d.pdb"
  Delete "$INSTDIR\lib\Debug\sfml-system-s.pdb"
  Delete "$INSTDIR\lib\Debug\sfml-window-s-d.pdb"
  Delete "$INSTDIR\lib\Debug\sfml-window-s.pdb"
  Delete "$INSTDIR\lib\flac.lib"
  Delete "$INSTDIR\lib\freetype.lib"
  Delete "$INSTDIR\lib\ogg.lib"
  Delete "$INSTDIR\lib\openal32.lib"
  Delete "$INSTDIR\lib\sfml-graphics-s-d.lib"
  Delete "$INSTDIR\lib\sfml-main-d.lib"
  Delete "$INSTDIR\lib\sfml-system-s-d.lib"
  Delete "$INSTDIR\lib\sfml-window-s-d.lib"
  Delete "$INSTDIR\lib\vorbis.lib"
  Delete "$INSTDIR\lib\vorbisenc.lib"
  Delete "$INSTDIR\lib\vorbisfile.lib"
...
!endif
  ...
  DeleteRegKey SHCTX "Software\Microsoft\Windows\CurrentVersion\Uninstall\SFML 2.6.2"

  ;Remove the installation directory if it is empty.
  RMDir "$INSTDIR"

  ; Remove the registry entries.
  DeleteRegKey SHCTX "Software\SFML Team\SFML 2.6.2"
  ...
  DeleteRegKey /ifempty SHCTX "Software\SFML Team\SFML 2.6.2"
...
Function .onInit
  ...
  ReadRegStr $0 HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\SFML 2.6.2" "UninstallString"
  StrCmp $0 "" inst

  MessageBox MB_YESNOCANCEL|MB_ICONEXCLAMATION \
  "SFML 2.6.2 (MSVC 19.41.34120.0) is already installed. $\n$\nDo you want to uninstall the old version before installing the new one?" \
...
inst:
  ...
  StrCmp "$INSTDIR" "$PROGRAMFILES\SFML 2.6.2" 0 +2
  ...
  StrCmp "$IS_DEFAULT_INSTALLDIR" "1" 0 +2
    StrCpy $INSTDIR "$DOCUMENTS\SFML 2.6.2"
  ...
  StrCmp $SV_ALLUSERS "AllUsers" 0 +3
    StrCmp "$IS_DEFAULT_INSTALLDIR" "1" 0 +2
      StrCpy $INSTDIR "$PROGRAMFILES\SFML 2.6.2"
